  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      if (isSignupMode) {
        ...
        const validation = staffLoginSchema.safeParse({
          userId,
          password
        });
        if (!validation.success) {
  ...
  return <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 gradient-primary relative overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col justify-center px-16 text-white">
          <div className="flex items-center gap-3 mb-8">
            ...
            <span className="text-3xl font-bold">ESWARI CONNECTS</span>
          </div>
          ...
          <p className="text-lg text-white/80 max-w-md animate-fade-in" style={{
          animationDelay: "0.1s"
        }}>
          ...
          <div className="mt-12 flex gap-6 animate-fade-in" style={{
          animationDelay: "0.2s"
        }}>
        ...
        <div className="absolute top-20 -right-10 w-40 h-40 bg-white/10 rounded-full blur-2xl animate-float" style={{
        animationDelay: "2s"
      }} />
      </div>
      ...
      <div className="flex-1 flex items-center justify-center p-8 bg-background">
        <div className="w-full max-w-md animate-scale-in">
          ...
          {!isSignupMode && adminExists && <Tabs value={loginType} onValueChange={v => setLoginType(v as "admin" | "staff")} className="mb-6">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            {isSignupMode && <>
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    ...
                    <Input id="name" type="text" placeholder="Enter your full name" value={name} onChange={e => setName(e.target.value)} className="pl-12 h-12 input-field" required />
                  </div>
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    ...
                    <Input id="phone" type="tel" placeholder="Enter your phone number" value={phone} onChange={e => setPhone(e.target.value)} className="pl-12 h-12 input-field" required />
                  </div>
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    ...
                    <Input id="address" type="text" placeholder="Enter your address" value={address} onChange={e => setAddress(e.target.value)} className="pl-12 h-12 input-field" required />
                  </div>
                </div>
              </>}

            {/* Email field - only for admin login and signup */}
            {(isSignupMode || loginType === "admin") && <div className="space-y-2">
                <Label htmlFor="email" className="text-foreground">
                  Email
                </Label>
                <div className="relative">
                  <Mail className="absolute left-4 top-1/2 -translate-y-1/2 w-5 h-5 text-muted-foreground" />
                  <Input id="email" type="email" placeholder="Enter your email" value={email} onChange={e => setEmail(e.target.value)} className="pl-12 h-12 input-field" required />
                </div>
              </div>}

            {/* User ID field - only for staff/manager login */}
            {!isSignupMode && loginType === "staff" && <div className="space-y-2">
                <Label htmlFor="userId" className="text-foreground">
                  User ID
                </Label>
                <div className="relative">
                  <User className="absolute left-4 top-1/2 -translate-y-1/2 w-5 h-5 text-muted-foreground" />
                  <Input id="userId" type="text" placeholder="Enter your User ID (e.g., john_doe_staff_1234)" value={userId} onChange={e => setUserId(e.target.value)} className="pl-12 h-12 input-field" required />
                </div>
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <Input id="password" type={showPassword ? "text" : "password"} placeholder="Enter your password" value={password} onChange={e => setPassword(e.target.value)} className="pl-12 pr-12 h-12 input-field" required />
          ...
          {!isSignupMode && loginType === "staff" && <div className="mt-6 p-4 rounded-lg bg-muted/50 text-sm">
